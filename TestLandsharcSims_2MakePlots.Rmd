...
```{r}
d2 <- read.table("data/KatieSims_multivariate/2R_R30_1351142970_988_6_NumPops=30_NumInd=20Bayenv2LFMMpca.Cpval_alpha0.75", header=TRUE)
str(d2)
d2$lev <- d2$s_high
...
pdf("results/LandsharcAverageSignals.pdf", width=7, height=9)
  ...
  boxplot(log(d2$Md.mcd.subset, 10)~d2$lev, col=col2,
