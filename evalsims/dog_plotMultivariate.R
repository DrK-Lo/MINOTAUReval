...
plotUnivariate <- function(input_df, snp_pos, region_pos, plot_out) {
    ...
    par(mfrow=c(4,1), mar=c(2,4,1,2), oma=c(1,1,1,1))
    
    flex_manhattan(input_data, chr="chr", bp="bp", stat="Md", snp="rs", ylab="Mahalanobis Distance",
                   outThresh1=0.05, outType1="upper", outThresh2=0.01, outType2="upper", 
		   high_reg=region, high_snp_pos=snp)
    
    flex_manhattan(input_data, chr="chr", bp="bp", stat="Hd", snp="rs", ylab="Harmonic Mean Dist.",
                   outThresh1=0.05, outType1="upper", outThresh2=0.01, outType2="upper", 
   		   high_reg=region, high_snp_pos=snp)
    
    flex_manhattan(input_data, chr="chr", bp="bp", stat="Nd", snp="rs", ylab="Nearest Neighbord Dist.",
                   outThresh1=0.05, outType1="upper", outThresh2=0.01, outType2="upper", 
		   high_reg=region, high_snp_pos=snp)
    
    flex_manhattan(input_data, chr="chr", bp="bp", stat="Kd", snp="rs", ylab="Kernel Density",
                   outThresh1=0.05, outType1="upper", outThresh2=0.01, outType2="upper", 
		   high_reg=region, high_snp_pos=snp)
